...
(() => {
  ...
  var vF = (p, p2, p3) => p2 in p ? v2(p, p2, {
    enumerable: true,
    configurable: true,
    writable: true,
    value: p3
  ...
  var vF5 = (p10, p11, p12, p13) => {
    if (p11 && typeof p11 == "object" || typeof p11 == "function") {
      for (let v8 of v4(p11)) {
        if (!v6.call(p10, v8) && v8 !== p12) {
          v2(p10, v8, {
            get: () => p11[v8],
            enumerable: !(p13 = v3(p11, v8)) || p13.enumerable
          });
        }
      }
    }
  ...
  var vF7 = (p17, p18, p19) => {
    p19 = p17 != null ? v(v5(p17)) : {};
    return vF5(p18 || !p17 || !p17.__esModule ? v2(p19, "default", {
      value: p17,
      enumerable: true
    }) : p19, p17);
  };
  var vF8 = p20 => vF5(v2({}, "__esModule", {
    value: true
  }), p20);
  var vF9 = (p21, p22, p23) => {
